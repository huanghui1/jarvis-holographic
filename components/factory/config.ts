...
export const FACTORY_LAYOUT: ModelConfig[] = [
  ...
  { file: '大型钻攻中心.glb', position: [0, -2.5, -1], rotation: [0, Math.PI, 0], scale: SCALE * 2, label: '大型钻攻中心' },
  ...
  { file: '龙门cnc4.glb', position: [11, 0, -5.7], rotation: [0, 0, 0], scale: SCALE, label: '龙门cnc4' },
